...
const Problem: React.FC = () => {
  ...
  return (
    <section className="py-24 bg-[#050505] border-t border-white/5 relative overflow-hidden">
      {/* Background Ambience */}
      <div className="absolute top-1/2 left-0 w-[400px] h-[400px] bg-[#B7FF45]/5 blur-[120px] rounded-full pointer-events-none -ml-20 -mt-40"></div>
          ...
          <div className="lg:w-7/12 flex flex-col gap-6">
            {problems.map((p, index) => (
              <Reveal key={p.id} delay={0.2 + (index * 0.1)} className="w-full">
                <div className="bg-[#0a0a0a] border border-white/10 rounded-2xl p-8 md:p-10 flex flex-col md:flex-row gap-6 md:gap-10 hover:border-[#B7FF45]/30 transition-colors duration-500">
                  <span className="font-playfair text-6xl text-[#B7FF45] leading-none">
