  ...
  return (
    <footer id="footer" className="relative z-20 py-24 overflow-hidden bg-[#050505] border-t border-white/5">
      ...
      <div className="absolute inset-0 z-0 pointer-events-none">
         <div className="absolute w-[150%] h-[150%] -top-[40%] -right-[30%] bg-[radial-gradient(circle_farthest-corner_at_center,_var(--tw-gradient-stops))] from-[#B7FF45]/10 via-transparent to-black blur-[120px] opacity-30"></div>
      </div>
        ...
        <div className="flex flex-col md:flex-row justify-between items-start gap-16 md:gap-8">
          ...
          <div className="flex flex-col gap-6 flex-1">
            ...
            <div className="flex gap-4">
              <a 
                ...
                className="w-10 h-10 flex items-center justify-center rounded-full bg-white/5 border border-white/10 text-neutral-400 hover:text-[#B7FF45] hover:border-[#B7FF45]/50 transition-all duration-300"
              >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 gap-x-12 gap-y-6 md:gap-x-20">
            <div className="flex flex-col gap-4">
              ...
              >
                Portfolio
                <ArrowUpRight className="w-3.5 h-3.5 opacity-0 group-hover:opacity-100 transition-all text-[#B7FF45]" />
              </button>
              <button 
            ...
            <div className="flex flex-col gap-4 col-span-2 sm:col-span-1">
              <a 
                ...
                target="_blank" 
                rel="noopener noreferrer"
                className="group flex items-center gap-2 text-lg font-bold text-[#B7FF45] hover:text-white transition-all w-fit"
              >
                Contact
