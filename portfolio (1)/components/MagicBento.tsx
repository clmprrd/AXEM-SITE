...
const DEFAULT_GLOW_COLOR = '0, 250, 154'; // AXEM Green
...
const GlobalSpotlight: React.FC<any> = ({
  ...
  useEffect(() => {
    if (disableAnimations || !gridRef?.current || !enabled || !isVisible) return;
  ...
  }, [gridRef, disableAnimations, enabled, spotlightRadius, glowColor, isVisible]);
    ...
    <>
      ...
      <BentoCardGrid gridRef={gridRef}>
        {cards.map((card, index) => {
              ...
              >
                ...
                <div className="magic-bento-card__content">
                  <h2 className="magic-bento-card__title">
                      <EditableText value={card.title} storageKey={`bento_title_${index}`} />
                  </h2>
                  <p className="magic-bento-card__description">
                      <EditableText isTextarea value={card.desc} storageKey={`bento_desc_${index}`} />
                  </p>
                </div>
              </ParticleCard>
            );
          ...
          // Fallback static card (code kept for completeness from source)
          return (
            <div key={index} {...cardProps}>
                <div className="magic-bento-card__header">
                  <div className="magic-bento-card__label">{card.subtitle}</div>
                </div>
                <div className="magic-bento-card__content">
