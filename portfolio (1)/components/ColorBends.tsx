...
export default function ColorBends({
  ...
  useEffect(() => {
    ...
    renderer.setPixelRatio(Math.min(window.devicePixelRatio || 1, 1.5)); // Reduced DPR for performance
  ...
  }, [frequency, mouseInfluence, noise, parallax, scale, speed, transparent, warpStrength, isVisible]);
